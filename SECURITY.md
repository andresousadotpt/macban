...
**Preferred:** Use [GitHub private vulnerability reporting](https://github.com/andresousadotpt/macban/security/advisories/new) if available.
...
macban is a **local-first** macOS application. Reports we are interested in include:

- Unauthorized access to or corruption of user project data
...
- Sync conflicts from third-party sync tools (expected last-write-wins behavior)
