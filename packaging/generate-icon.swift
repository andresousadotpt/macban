...
let background = NSColor(calibratedRed: 0.28, green: 0.22, blue: 0.72, alpha: 1)
background.setFill()
...
if let symbol = NSImage(systemSymbolName: "rectangle.split.3x1", accessibilityDescription: nil)?
